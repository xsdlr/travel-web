...
export default {
    ...
    7:{
        "categories":[{name:'类目1'},{name:'类目2'},{name:'类目3'}],
        "nodes":[{
            name: '1',
            x: 0,
            y: 10,
    ...
    25:{
        "lngExtent":[29.88, 30.98],     //维度区域
        "latExtent":[119.64, 120.54],   //经度区域
        "cellCount":[50, 50],           //切割份数（data数据需和份数相对应）
        ...
        "list":[{"name":"重度","percent":"20%","changePercent":"5%",rise:true},{"name":"一般","percent":"31%","changePercent":"8%",rise:false},{"name":"轻度","percent":"19%","changePercent":"12%",rise:true},{"name":"畅通","percent":"30%","changePercent":"3%",rise:false}]
    },
    26:{
        "bus": 0.7,
        "metro": 0.3,
